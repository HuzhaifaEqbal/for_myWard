  ...
  return (
    <div className="w-full flex flex-col gap-4 select-none">
      ...
      <div className="w-full h-[540px] md:h-[620px] rounded-3xl overflow-hidden relative shadow-2xl border border-outline-variant/30 bg-[#051424]">
        ...
        <Canvas camera={{ position: [0, 18, 28], fov: 48 }} shadows={{ type: THREE.PCFShadowMap }}>
          <OrbitControls
            minDistance={8}
            maxDistance={55}
          ...
          <div className="absolute top-4 right-4 z-20 max-w-sm w-[90%] md:w-auto animate-fade-in pointer-events-auto">
            <div className="bg-surface/90 backdrop-blur-xl border-2 border-tertiary/40 rounded-2xl p-4 shadow-2xl text-right">
              ...
              <div className="flex items-center gap-3 mb-2">
                <div className="w-9 h-9 rounded-xl bg-surface border border-outline-variant/30 flex items-center justify-center text-tertiary">
                  {selectedTree.treeType === 'palm' || selectedTree.deedType === 'quran' ? (
                    <svg className="w-5 h-5 text-emerald-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                      <path d="M12 22v-9" />
                      <path d="M12 13a5 5 0 0 0 5-5c0-4-5-6-5-6s-5 2-5 6a5 5 0 0 0 5 5z" />
                    </svg>
                  ) : selectedTree.treeType === 'olive' ? (
